...
function extendConf (conf, api) {
  ...
  conf.boot.push('~quasar-app-extension-cupola/src/boot/register.js')
  ...
  if (api.hasWebpack) {
    ...
    transpileTarget.push(/quasar-app-extension-cupola[\\/]src/)
  }

  // make sure the stylesheet goes through webpack to avoid SSR issues
  conf.css.push('~quasar-ui-cupola/src/index.sass')
}
...
export default function (api) {
  ...
  // api.registerDescribeApi('home', '~quasar-ui-cupola/src/components/home.json')
